...
- The `claude-sonnet-4-6` model handles all reasoning. `claude-haiku-4-5-20251001` is used only for `patch_scene` and `update_theme` (lightweight structured edits).
